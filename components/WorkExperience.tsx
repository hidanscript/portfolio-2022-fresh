...
export default function MainSection () {
    return (
        <Container>
            ...
            <span class={tw`text-sm text-black m-0 pill px-2.5 py-0.5 mt-1 rounded-full`}>NodeJS Developer</span>
            ...
            <span class={tw`text-sm text-black m-0 pill px-2.5 py-0.5 mt-1 rounded-full`}>Fullstack Developer</span>
            <p class={tw`text-base dark:text-white`} style={styles.text}>
